...
public class ForegroundLocationService extends Service implements LocationListener
{
    ...
    public void onLocationChanged(Location _location)
    {
        ...
        // context.sendBroadcast(locationAppIntent);
        locationAppIntent.setPackage("tcs.lbs.locationapp");
        sendBroadcast(locationAppIntent);

        // Send inter-app broadcast to WeatherApp

        // send inter-app broadcast to predefined apps
        // weatherIntent.setPackage("tcs.lbs.weather_app");
        // sendBroadcast(weatherIntent);

        // send inter-app broadcast restricted to apps with location permission
        sendBroadcast(weatherIntent, Manifest.permission.ACCESS_FINE_LOCATION);
    }
