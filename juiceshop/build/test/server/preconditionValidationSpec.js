...
describe('preconditionValidation', () => {
    describe('checkIfRunningOnSupportedNodeVersion', () => {
        ...
        it('should accept a supported version', () => {
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('21.0.0')).to.equal(true);
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('20.0.0')).to.equal(true);
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('19.6.0')).to.equal(true);
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('18.1.0')).to.equal(true);
        });
        it('should fail for an unsupported version', () => {
            expect((0, validatePreconditions_1.checkIfRunningOnSupportedNodeVersion)('22.0.0')).to.equal(false);
